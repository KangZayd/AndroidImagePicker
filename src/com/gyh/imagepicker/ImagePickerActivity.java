...
public abstract class ImagePickerActivity extends Activity {
	...
	public void toggleImagePicker() {
		...
		if (pickerView.getVisibility() == View.VISIBLE) {
			...
			pickerView.findViewById(R.id.layout_pick_photo).startAnimation(
					popUpInAnim);
		}
	}
	...
	/**
	 * this will be called when a image has been cropped successfully
	 * @param file
	 */
	...
	private class ImagePickerOnClickerListener implements OnClickListener {
